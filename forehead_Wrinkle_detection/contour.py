...
def crop_forehead(img_array,cordinates):
	...
	x2_new=int(x1_new+dist)

	y2_new=int(y1_new+dist)


	forehead = img[y1_new-10:y2_new-10,x1_new-10:x2_new+80] #crop images
	"""
	...
	forehead = img[y1_new+100:height-80,x1_new-80:width+700] #crop images
	...
	return [(x1_new,y1_new),(x2_new,y2_new)],4
